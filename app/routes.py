...
def index():
    ...
    # Fetch posts of all followd users
...
def user(username):
    ...
    return render_template("user.html", user=user, posts=posts.items,
                           nex_url=next_url, prev_url=prev_url, form=form)
...
# Adds the follow and unfollow functionality
...
# Explore recent posts by all users
@app.route("/explore")
@login_required
def explore():
    page = request.args.get("page", 1, type=int)
